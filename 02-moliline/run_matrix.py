# -*- coding: utf-8 -*-
"""MoliLine v1.0 baseline matrix runner (Python subprocess)."""
...
try:
    ...
    res["echo"] = ctl("SEND","executor","ECHO hello moliline")
    ...
    open(os.path.join(ROOT, "results", "moliline_matrix.json"), "w",
